...
<center>
##Explore scRNA-seq expression data from Hook, _et al_., 2017
</center>
***
...
####Instructions:  
Enter the symbol of your favorite mouse gene below to see the expression of that gene in each population of cells indentified in Hook, _et al_., 2017. If the plot is not produced for a gene, the gene did not pass quality control filtering for the dataset in its entirety.   

Last code update: `r Sys.Date()` 
...
**bioRxiv Citation**: Single-cell RNA-seq of mouse dopaminergic neurons informs candidate gene selection for sporadic Parkinson's disease. Paul W. Hook, Sarah A. McClymont, Gabrielle H. Cannon, William D. Law, A. Jennifer Morton, Loyal A. Goff, Andrew S. McCallion. bioRxiv 148049; doi: https://doi.org/10.1101/148049 
